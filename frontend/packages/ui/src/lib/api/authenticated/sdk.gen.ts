...
export const revoke = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).post<RevokeResponses, unknown, ThrowOnError>({
...
export const cicdSample = <ThrowOnError extends boolean = false>(
  options?: Options<CicdSampleData, ThrowOnError>
) =>
  (options?.client ?? client).get<CicdSampleResponses, unknown, ThrowOnError>({
...
export const user = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<UserResponses, unknown, ThrowOnError>({
    url: "/api/auth/user",
    ...options,
  })
